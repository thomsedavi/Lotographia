...
export const OfficeMeeting: GameOptionDetails = {
  ...
  footnote: "This is the first game where I've created an image deliberately for this game. Also, the first with a custom font, other than the System fonts of Monospace, Serif and SansSerif. Custom font is Journal by Fontourist",
  height: 600,
  width: 900,
  base: "MeticulousSkeleton/OfficeMeeting.png",
  lotoColour: "#221",
  lotoBackground: "none",
  substituteTexts: [
    {
